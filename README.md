## LaravelShoppingcart
[![Build Status](https://travis-ci.org/devability/LaravelShoppingcart.png?branch=master)](https://travis-ci.org/devability/LaravelShoppingcart)
[![Total Downloads](https://poser.pugx.org/devability/shoppingcart/downloads.png)](https://packagist.org/packages/devability/shoppingcart)
[![Latest Stable Version](https://poser.pugx.org/devability/shoppingcart/v/stable)](https://packagist.org/packages/devability/shoppingcart)
[![Latest Unstable Version](https://poser.pugx.org/devability/shoppingcart/v/unstable)](https://packagist.org/packages/devability/shoppingcart)
...
Run the Composer require command from the Terminal:
    ...
    composer require devability/shoppingcart
